...
void loop() {
  ...
  if(noiseFiltering ==  true){
    ...
    greenOutput=(1.0*greenAvg/readingNr > highPassVal)? 1.0*greenAvg/readingNr : 0;
    redOutput=(1.0*redAvg/readingNr > highPassVal)? 1.0*redAvg/readingNr : 0;
    blueOutput=(1.0*blueAvg/readingNr > highPassVal)? 1.0*blueAvg/readingNr : 0;
  }else{
